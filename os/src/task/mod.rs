...
/// Add the time evoking the syscall numbered id
pub fn add_current_evoke(syscall_id: usize) {
    TASK_MANAGER.add_current_evoke(syscall_id);
}

/// Ask the time evoking the syscall numbered id
pub fn ask_current_evoke(syscall_id: usize) -> isize {
    TASK_MANAGER.ask_current_evoke(syscall_id)
}